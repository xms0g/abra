...
public:
	...
	void setFloatArray(const char* name, const float* values, uint32_t count) const;
	...
	void setMat4Array(const char* name, const glm::mat4* matrices, size_t count) const;

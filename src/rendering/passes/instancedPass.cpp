...
void InstancedPass::configure(const RenderContext& ctx, const FrameGraph& graph, EventBus& eventBus) {
...
void InstancedPass::execute(const RenderContext& ctx, const FrameGraph& graph) {
